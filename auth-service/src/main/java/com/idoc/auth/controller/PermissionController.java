...
public class PermissionController {
  ...
  public ResponseEntity<Map<String, Object>> getAll() {
    ...
    return ResponseUtil.buildSuccessResponse("Permissions retrieved successfully", data);
  }
  ...
  public ResponseEntity<Map<String, Object>> getPermissionById(@PathVariable Long id) {
    ...
    return ResponseUtil.buildSuccessResponse("Permission retrieved successfully", data);
  }
  ...
  public ResponseEntity<Map<String, Object>> createPermission(@RequestBody PermissionDto permission) {
    ...
    return ResponseUtil.buildCreatedResponse("Permission created successfully", data);
  }
  ...
  public ResponseEntity<Map<String, Object>> updatePermission(@PathVariable Long id,
    ...
    return ResponseUtil.buildSuccessResponse("Permission updated successfully", data);
  }
  ...
  public ResponseEntity<Map<String, Object>> partialUpdatePermission(@PathVariable Long id,
    ...
    return ResponseUtil.buildSuccessResponse("Permission partially updated successfully", data);
  }
  ...
  public ResponseEntity<Map<String, Object>> deletePermission(@PathVariable Long id) {
    ...
    return ResponseUtil.buildAcceptedResponse("Permission deleted successfully");
  }
