 ...
 * @access  Private (Authentication users only)
 */
router.put('/:id', authenticateToken, authorizeRole('admin'), ProfileController.update);
 ...
 * @access  Private (Authentication users only)
 */
router.delete('/:id', authenticateToken, authorizeRole('admin'), ProfileController.delete);
